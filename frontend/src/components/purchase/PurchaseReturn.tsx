...
import { AutoComplete, Button, Col, DatePicker, Input, InputNumber, Layout, Row, Table } from 'antd';
    ...
    <Col span={24} style={{ display: 'flex',
      ...
      <Col span={24} style={{ display: 'flex',
        ...
        <div style={{ display: 'flex',
          alignItems: 'center'}}>
          <h4 style={{ margin: '0',
            marginRight: '5px'}}>Reference No.</h4>
          <InputNumber min={1} max={100000} defaultValue={12035} disabled={true} />
        </div>
        <div style={{ display: 'flex',
          alignItems: 'center'}}>
          <h4 style={{ margin: '0',
            marginRight: '5px'}}>Return Date</h4>
...
const SubTotal = function() {
  ...
  return (
    <Col span={24} style={{ display: 'flex',
      ...
      marginTop: '15px' }}>
      <Col span={18}>
        <Col span={14} className='total_line' style={{ display: 'flex',
          justifyContent: 'space-between' }}>
        ...
        <Col span={6} className='total_line' style={{ display: 'flex',
          justifyContent: 'space-between',
          marginTop: '10px' }}>
          <Col span={24} style={{ display: 'flex',
            justifyContent: 'space-between' }}>
      ...
      <Layout>
        <Row className='main_div'>
          ...
          <h1 style={{ textAlign: 'right',
            width: '100%',
            paddingRight: '10%'}}>Rupees : Fifty three and paise twenty five only</h1>
        </Row>
      </Layout>
    );
